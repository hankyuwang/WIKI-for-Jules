...
### 2. 範圍 (Scope)
- **雲端/資料中心級晶片**：NVIDIA Hopper (H100/H200) & Blackwell (B200)、Google TPU v4 & v5p & Trillium (TPU v6) & TPU v7、AMD Instinct MI300X/MI325X、AWS Trainium2 & Inferentia2、Intel Gaudi 3。
...
| **Google TPU v7** | 規格尚未公開 | 規格尚未公開 | 規格尚未公開 | 規格尚未公開 | 規格尚未公開 | 規格尚未公開 | 規格尚未公開 |
